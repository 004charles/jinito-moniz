/** Arquitetura de Âmbar: mosaico de ouro e análise material, com lightbox para inspeção visual. */
...
export default function Gallery() {
  ...
  return (
    <section id="galeria" className="bg-[#eee8dd] px-5 py-24 sm:px-8 lg:px-12 lg:py-32"><div className="mx-auto max-w-[1320px]"><SectionHeading index="04" eyebrow="Ouro em detalhe" title="Cada peça tem a sua história." description="Uma seleção visual do universo que analisamos: matéria, forma, textura e os detalhes que merecem atenção." light align="right" />
